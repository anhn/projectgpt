...
with st.form("my_form"):
      ...
      st.selectbox("Develop a risk table and calcualte risk score")
      st.selectbox("Develop a countermeasurement for risk items")
      st.write("7. Communication management")
      st.selectbox("Define roles in the projects")
      st.selectbox("Develop a communication plan table")
