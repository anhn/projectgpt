...
with tab1:
    ...
    if prompt := st.chat_input("What is up?"):
        ...
        st.session_state.messages.append({"role": "system", "content": get_course_description("module1")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module2")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module3")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module4")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module5")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module6")})
        st.session_state.messages.append({"role": "system", "content": get_course_description("module7")})        
        st.session_state.messages.append({"role": "system", "content": get_course_description("module8")})
